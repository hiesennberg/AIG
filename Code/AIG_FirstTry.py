# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 19:09:12 2020
...
transform = transforms.Compose([transforms.Resize(imageSize), transforms.ToTensor(), transforms.Normalize((0.5,),(0.5,)),]) # We create a list of transformations (scaling, tensor conversion, normalization) to apply to the input images.

# Loading the dataset
folderpath = r'C:\Users\Nishant\Documents\Hackathon\AIG\faultyimages'

dataset = dset.ImageFolder(folderpath,transform=transform,)
...
for epoch in range(5): # We iterate over 25 epochs.
    ...
    for i, data in enumerate(dataloader, 0): # We iterate over the images of the dataset.
        ...
        print('Epoch :',epoch,'Error D: ',errD,'    Error G: ',errG)
